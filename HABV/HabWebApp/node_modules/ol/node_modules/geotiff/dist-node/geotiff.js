...
},{"_bundle_loader":"TUK3","./raw":[["raw.36b0eaaf.js","V9bQ"],"raw.36b0eaaf.js.map","V9bQ"],"./lzw":[["lzw.bba3a69d.js","tcId"],"lzw.bba3a69d.js.map","tcId"],"./jpeg":[["jpeg.c9bf0c7a.js","J7kk"],"jpeg.c9bf0c7a.js.map","J7kk"],"./deflate":[["deflate.c1d0255b.js","JAiC"],"deflate.c1d0255b.js.map","JAiC"],"./packbits":[["packbits.4893e615.js","OcPz"],"packbits.4893e615.js.map","OcPz"],"./lerc":[["lerc.7551d1db.js","YN9V"],"lerc.7551d1db.js.map","YN9V"]}],"OQju":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("@petamoriken/float16"),e=require("txml/txml"),i=require("./globals"),r=require("./rgb"),a=require("./compression"),o=require("./resample");function s(t,e,i){let r=0;for(let a=e;a<i;++a)r+=t[a];return r}function n(t,e,i){switch(t){case 1:if(e<=8)return new Uint8Array(i);if(e<=16)return new Uint16Array(i);if(e<=32)return new Uint32Array(i);break;case 2:if(8===e)return new Int8Array(i);if(16===e)return new Int16Array(i);if(32===e)return new Int32Array(i);break;case 3:switch(e){case 16:case 32:return new Float32Array(i);case 64:return new Float64Array(i)}}throw Error("Unsupported data format/bitsPerSample")}function l(t,e){return(1!==t&&2!==t||!(e<=32)||e%8!=0)&&(3!==t||16!==e&&32!==e&&64!==e)}function h(t,e,i,r,a,o,s){const l=new DataView(t),h=2===i?1:r,c=n(e,a,2===i?s*o:s*o*r),g=parseInt("1".repeat(a),2);if(1===e){let t,e=o*(t=1===i?r*a:a);0!=(7&e)&&(e=e+7&-8);for(let i=0;i<s;++i){const t=i*e;for(let e=0;e<o;++e){const r=t+e*h*a;for(let t=0;t<h;++t){const s=r+t*a,n=(i*o+e)*h+t,f=Math.floor(s/8),p=s%8;if(p+a<=8)c[n]=l.getUint8(f)>>8-a-p&g;else if(p+a<=16)c[n]=l.getUint16(f)>>16-a-p&g;else if(p+a<=24){const t=l.getUint16(f)<<8|l.getUint8(f+2);c[n]=t>>24-a-p&g}else c[n]=l.getUint32(f)>>32-a-p&g}}}}return c.buffer}class c{constructor(t,e,i,r,a,o){this.fileDirectory=t,this.geoKeys=e,this.dataView=i,this.littleEndian=r,this.tiles=a?{}:null,this.isTiled=!t.StripOffsets;const s=t.PlanarConfiguration;if(this.planarConfiguration=void 0===s?1:s,1!==this.planarConfiguration&&2!==this.planarConfiguration)throw new Error("Invalid planar configuration.");this.source=o}getFileDirectory(){return this.fileDirectory}getGeoKeys(){return this.geoKeys}getWidth(){return this.fileDirectory.ImageWidth}getHeight(){return this.fileDirectory.ImageLength}getSamplesPerPixel(){return void 0!==this.fileDirectory.SamplesPerPixel?this.fileDirectory.SamplesPerPixel:1}getTileWidth(){return this.isTiled?this.fileDirectory.TileWidth:this.getWidth()}getTileHeight(){return this.isTiled?this.fileDirectory.TileLength:void 0!==this.fileDirectory.RowsPerStrip?Math.min(this.fileDirectory.RowsPerStrip,this.getHeight()):this.getHeight()}getBlockWidth(){return this.getTileWidth()}getBlockHeight(t){return this.isTiled||(t+1)*this.getTileHeight()<=this.getHeight()?this.getTileHeight():this.getHeight()-t*this.getTileHeight()}getBytesPerPixel(){let t=0;for(let e=0;e<this.fileDirectory.BitsPerSample.length;++e)t+=this.getSampleByteSize(e);return t}getSampleByteSize(t){if(t>=this.fileDirectory.BitsPerSample.length)throw new RangeError(`Sample index ${t} is out of range.`);return Math.ceil(this.fileDirectory.BitsPerSample[t]/8)}getReaderForSample(e){const i=this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[e]:1,r=this.fileDirectory.BitsPerSample[e];switch(i){case 1:if(r<=8)return DataView.prototype.getUint8;if(r<=16)return DataView.prototype.getUint16;if(r<=32)return DataView.prototype.getUint32;break;case 2:if(r<=8)return DataView.prototype.getInt8;if(r<=16)return DataView.prototype.getInt16;if(r<=32)return DataView.prototype.getInt32;break;case 3:switch(r){case 16:return function(e,i){return(0,t.getFloat16)(this,e,i)};case 32:return DataView.prototype.getFloat32;case 64:return DataView.prototype.getFloat64}}throw Error("Unsupported data format/bitsPerSample")}getSampleFormat(t=0){return this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[t]:1}getBitsPerSample(t=0){return this.fileDirectory.BitsPerSample[t]}getArrayForSample(t,e){return n(this.getSampleFormat(t),this.getBitsPerSample(t),e)}async getTileOrStrip(t,e,i,r,a){const o=Math.ceil(this.getWidth()/this.getTileWidth()),s=Math.ceil(this.getHeight()/this.getTileHeight());let n;const{tiles:c}=this;let g,f;1===this.planarConfiguration?n=e*o+t:2===this.planarConfiguration&&(n=i*o*s+e*o+t),this.isTiled?(g=this.fileDirectory.TileOffsets[n],f=this.fileDirectory.TileByteCounts[n]):(g=this.fileDirectory.StripOffsets[n],f=this.fileDirectory.StripByteCounts[n]);const p=(await this.source.fetch([{offset:g,length:f}],a))[0];let u;return null!==c&&c[n]?u=c[n]:(u=(async()=>{let t=await r.decode(this.fileDirectory,p);const i=this.getSampleFormat(),a=this.getBitsPerSample();return l(i,a)&&(t=h(t,i,this.planarConfiguration,this.getSamplesPerPixel(),a,this.getTileWidth(),this.getBlockHeight(e))),t})(),null!==c&&(c[n]=u)),{x:t,y:e,sample:i,data:await u}}async _readRaster(t,e,i,r,a,n,l,h,c){const g=this.getTileWidth(),f=this.getTileHeight(),p=Math.max(Math.floor(t[0]/g),0),u=Math.min(Math.ceil(t[2]/g),Math.ceil(this.getWidth()/this.getTileWidth())),m=Math.max(Math.floor(t[1]/f),0),d=Math.min(Math.ceil(t[3]/f),Math.ceil(this.getHeight()/this.getTileHeight())),y=t[2]-t[0];let w=this.getBytesPerPixel();const D=[],M=[];for(let o=0;o<e.length;++o)1===this.planarConfiguration?D.push(s(this.fileDirectory.BitsPerSample,0,e[o])/8):D.push(0),M.push(this.getReaderForSample(e[o]));const S=[],{littleEndian:T}=this;for(let o=m;o<d;++o)for(let s=p;s<u;++s)for(let n=0;n<e.length;++n){const l=n,h=e[n];2===this.planarConfiguration&&(w=this.getSampleByteSize(n));const p=this.getTileOrStrip(s,o,h,a,c);S.push(p),p.then(a=>{const o=a.data,s=new DataView(o),n=this.getBlockHeight(a.y),h=a.y*f,c=a.x*g,p=h+n,u=(a.x+1)*g,m=M[l],d=Math.min(n,n-(p-t[3])),S=Math.min(g,g-(u-t[2]));for(let f=Math.max(0,t[1]-h);f<d;++f)for(let a=Math.max(0,t[0]-c);a<S;++a){const o=(f*g+a)*w,n=m.call(s,o+D[l],T);let p;r?(p=(f+h-t[1])*y*e.length+(a+c-t[0])*e.length+l,i[p]=n):(p=(f+h-t[1])*y+a+c-t[0],i[l][p]=n)}})}if(await Promise.all(S),n&&t[2]-t[0]!==n||l&&t[3]-t[1]!==l){let a;return(a=r?(0,o.resampleInterleaved)(i,t[2]-t[0],t[3]-t[1],n,l,e.length,h):(0,o.resample)(i,t[2]-t[0],t[3]-t[1],n,l,h)).width=n,a.height=l,a}return i.width=n||t[2]-t[0],i.height=l||t[3]-t[1],i}async readRasters({window:t,samples:e=[],interleave:i,pool:r=null,width:o,height:s,resampleMethod:l,fillValue:h,signal:c}={}){const g=t||[0,0,this.getWidth(),this.getHeight()];if(g[0]>g[2]||g[1]>g[3])throw new Error("Invalid subsets");const f=(g[2]-g[0])*(g[3]-g[1]),p=this.getSamplesPerPixel();if(e&&e.length){for(let a=0;a<e.length;++a)if(e[a]>=p)return Promise.reject(new RangeError(`Invalid sample index '${e[a]}'.`))}else for(let a=0;a<p;++a)e.push(a);let u;if(i){u=n(this.fileDirectory.SampleFormat?Math.max.apply(null,this.fileDirectory.SampleFormat):1,Math.max.apply(null,this.fileDirectory.BitsPerSample),f*e.length),h&&u.fill(h)}else{u=[];for(let t=0;t<e.length;++t){const i=this.getArrayForSample(e[t],f);Array.isArray(h)&&t<h.length?i.fill(h[t]):h&&!Array.isArray(h)&&i.fill(h),u.push(i)}}const m=r||await(0,a.getDecoder)(this.fileDirectory);return await this._readRaster(g,e,u,i,m,o,s,l,c)}async readRGB({window:t,interleave:e=!0,pool:a=null,width:o,height:s,resampleMethod:n,enableAlpha:l=!1,signal:h}={}){const c=t||[0,0,this.getWidth(),this.getHeight()];if(c[0]>c[2]||c[1]>c[3])throw new Error("Invalid subsets");const g=this.fileDirectory.PhotometricInterpretation;if(g===i.photometricInterpretations.RGB){let r=[0,1,2];if(this.fileDirectory.ExtraSamples!==i.ExtraSamplesValues.Unspecified&&l){r=[];for(let t=0;t<this.fileDirectory.BitsPerSample.length;t+=1)r.push(t)}return this.readRasters({window:t,interleave:e,samples:r,pool:a,width:o,height:s,resampleMethod:n,signal:h})}let f;switch(g){case i.photometricInterpretations.WhiteIsZero:case i.photometricInterpretations.BlackIsZero:case i.photometricInterpretations.Palette:f=[0];break;case i.photometricInterpretations.CMYK:f=[0,1,2,3];break;case i.photometricInterpretations.YCbCr:case i.photometricInterpretations.CIELab:f=[0,1,2];break;default:throw new Error("Invalid or unsupported photometric interpretation.")}const p={window:c,interleave:!0,samples:f,pool:a,width:o,height:s,resampleMethod:n,signal:h},{fileDirectory:u}=this,m=await this.readRasters(p),d=2**this.fileDirectory.BitsPerSample[0];let y;switch(g){case i.photometricInterpretations.WhiteIsZero:y=(0,r.fromWhiteIsZero)(m,d);break;case i.photometricInterpretations.BlackIsZero:y=(0,r.fromBlackIsZero)(m,d);break;case i.photometricInterpretations.Palette:y=(0,r.fromPalette)(m,u.ColorMap);break;case i.photometricInterpretations.CMYK:y=(0,r.fromCMYK)(m);break;case i.photometricInterpretations.YCbCr:y=(0,r.fromYCbCr)(m);break;case i.photometricInterpretations.CIELab:y=(0,r.fromCIELab)(m);break;default:throw new Error("Unsupported photometric interpretation.")}if(!e){const t=new Uint8Array(y.length/3),e=new Uint8Array(y.length/3),i=new Uint8Array(y.length/3);for(let r=0,a=0;r<y.length;r+=3,++a)t[a]=y[r],e[a]=y[r+1],i[a]=y[r+2];y=[t,e,i]}return y.width=m.width,y.height=m.height,y}getTiePoints(){if(!this.fileDirectory.ModelTiepoint)return[];const t=[];for(let e=0;e<this.fileDirectory.ModelTiepoint.length;e+=6)t.push({i:this.fileDirectory.ModelTiepoint[e],j:this.fileDirectory.ModelTiepoint[e+1],k:this.fileDirectory.ModelTiepoint[e+2],x:this.fileDirectory.ModelTiepoint[e+3],y:this.fileDirectory.ModelTiepoint[e+4],z:this.fileDirectory.ModelTiepoint[e+5]});return t}getGDALMetadata(t=null){const i={};if(!this.fileDirectory.GDAL_METADATA)return null;const r=this.fileDirectory.GDAL_METADATA,a=(0,e.parse)(r.substring(0,r.length-1));if(!a[0].tagName)throw new Error("Failed to parse GDAL metadata XML.");const o=a[0];if("GDALMetadata"!==o.tagName)throw new Error("Unexpected GDAL metadata XML tag.");let s=o.children.filter(t=>"Item"===t.tagName);null!==t&&(s=s.filter(e=>Number(e.attributes.sample)===t));for(let e=0;e<s.length;++e){const t=s[e];i[t.attributes.name]=t.children[0]}return i}getGDALNoData(){if(!this.fileDirectory.GDAL_NODATA)return null;const t=this.fileDirectory.GDAL_NODATA;return Number(t.substring(0,t.length-1))}getOrigin(){const t=this.fileDirectory.ModelTiepoint,e=this.fileDirectory.ModelTransformation;if(t&&6===t.length)return[t[3],t[4],t[5]];if(e)return[e[3],e[7],e[11]];throw new Error("The image does not have an affine transformation.")}getResolution(t=null){const e=this.fileDirectory.ModelPixelScale,i=this.fileDirectory.ModelTransformation;if(e)return[e[0],-e[1],e[2]];if(i)return[i[0],i[5],i[10]];if(t){const[e,i,r]=t.getResolution();return[e*t.getWidth()/this.getWidth(),i*t.getHeight()/this.getHeight(),r*t.getWidth()/this.getWidth()]}throw new Error("The image does not have an affine transformation.")}pixelIsArea(){return 1===this.geoKeys.GTRasterTypeGeoKey}getBoundingBox(){const t=this.getOrigin(),e=this.getResolution(),i=t[0],r=t[1],a=i+e[0]*this.getWidth(),o=r+e[1]*this.getHeight();return[Math.min(i,a),Math.min(r,o),Math.max(i,a),Math.max(r,o)]}}var g=c;exports.default=g;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("threads");const r="undefined"!=typeof navigator?navigator.hardwareConcurrency:null;class t{constructor(t=r,o=new e.Worker("/decoder.worker.412c5d49.js")){this.pool=(0,e.Pool)(()=>(0,e.spawn)(o),t)}async decode(r,t){return new Promise((o,a)=>{this.pool.queue(async s=>{try{const c=await s(r,(0,e.Transfer)(t));o(c)}catch(n){a(n)}})})}destroy(){this.pool.terminate(!0)}}var o=t;exports.default=o;
},{"./decoder.worker.js":[["decoder.worker.412c5d49.js","LHx9"],"decoder.worker.412c5d49.js.map","LHx9"]}],"ZJpj":[function(require,module,exports) {
