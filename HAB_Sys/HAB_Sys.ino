...
#define SCL 21
#define SDA 20
#define DATA_HEADERS "Date, Time, UV, IR, Visible, ThermoCouple Internal Temp (C), ThermoCouple Temp (C), ThermoCouple Temp (F), Altitude (m), Pressure (Pa), Altimeter Temp (C), Altimeter Digital Temp, Altimeter Digital Pressure, Tracksoar Altitude, Tracksoar Latitude, Tracksoar Longitude, Tracksoar Speed, Servo1 Extended, Servo2 Extended, Ambient System Temperature, Ambient Outside Temperature"
...
void setup() {
  ...
  setup_all(baro, thermocouple, thermocouple_cam, RTC, system_sensor, outer_sensor);
...
void loop() {
  run_experiment(launch_start, baro, thermocouple, thermocouple_cam, RTC, system_sensor, outer_sensor);
}
